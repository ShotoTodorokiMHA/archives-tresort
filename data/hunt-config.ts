...
export const defaultHuntConfig: HuntConfig = {
  admin: {
    ...
    title: "Admin",
    description: "Accès interne pour modifier les boîtes et remettre à zéro la progression partagée.",
    ...
    successMessage: "Progression réinitialisée.",
  ...
  siteLock: {
    ...
    heading: "Accès privé",
    message:
      "Le site s'ouvrira officiellement le 28 mars 2026 à 11:00, heure de Paris. Si vous avez le mot de passe, vous pouvez entrer dès maintenant.",
  ...
  title: "Archives Treasures Hunt",
  subtitle:
    "Parcourez Rennes librement, trouvez les boîtes dans l'ordre que vous voulez et entrez le bon code pour les valider.",
  intro:
    "Progression partagée en direct entre tous les participants. Toutes les boîtes sont ouvertes dès le départ pour envoyer les gens dans toute la ville.",
  startButtonLabel: "Voir la carte",
  codeInputLabel: "Code à 4 chiffres",
  codeInputPlaceholder: "0000",
  codeHelperText: "Entrez le code trouvé sur place.",
  codeErrorMessage: "Code incorrect. Vérifiez la boîte et réessayez.",
  validateButtonLabel: "Valider le code",
  successTitle: "Boîte trouvée",
  successMessage:
  ...
  finalMessage:
    "La chasse est finie, merci a tous !",
  finalCode: "",
  finalRewardHint: "",
  center: {
    lat: 48.10964,
